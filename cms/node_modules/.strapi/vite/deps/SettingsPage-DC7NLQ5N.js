...
var SettingsPage = () => {
  ...
  const { data: imageCountResponse, isLoading: isLoadingImagesWithoutMetadataCount } = useQuery([
    ...
    const { data: data2 } = await get("/upload/ai-metadata-jobs/pending-count");
    return data2;
  }, {
  ...
  const { mutateAsync: startGenerateAIMetadata } = useMutation(async () => {
    const { data: data2 } = await post("/upload/ai-metadata-jobs", {});
    return data2;
  }, {
    onSuccess() {
...
//# sourceMappingURL=SettingsPage-DC7NLQ5N.js.map
